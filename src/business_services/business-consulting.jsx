// BusinessConsulting.jsx – Professional business & strategy consulting
...
/* ── AUTO-SCROLL STRIP (consulting keywords) ── */
const scrollItems = [
...
/* ── Consulting Services (6 cards covering all topics) ── */
const services = [
  {
    title: "Business Intelligence",
    icon: <HiOutlineChartBar />,
    desc: "Improve the overall flow of business and address compliance with data regulations. Help firms gain a competitive edge by analyzing issues in finance, people, sales, and operations, developing plans for improvement.",
    img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format&fit=crop",
    tags: ["Data", "Compliance", "Competitive Edge"],
  },
  {
    title: "Business Acceleration Through Technology Integration",
    icon: <HiOutlineChip />,
    desc: "Gain objective understanding of your business and take control of financial health. Refine your value proposition by integrating technology into processes. Whether cutting costs or deploying revolutionary products, we’ve got you covered.",
    img: "https://images.unsplash.com/photo-1581092335871-4b6b5c7c3b9a?q=80&w=800&auto=format&fit=crop",
    tags: ["Tech Integration", "Cost Cutting", "Innovation"],
  },
  {
    title: "Intelligent Management Consulting & Objective Planning",
    icon: <HiOutlineClipboardList />,
    desc: "Address functional and vertical challenges, develop improvement plans. Gain advantage by analyzing finance, people, sales, and operations. Improve business flow, address data regulations, evaluate with analytics, and modify tactics to build success.",
    img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=800&auto=format&fit=crop",
    tags: ["Management", "Analytics", "Tactics"],
  },
  {
    title: "Objective Planning & Leadership Advisory",
    icon: <HiOutlineUserGroup />,
    desc: "Through deep industrial experience, we support strategic planning and talent advisory. Assist strategy implementation, define mission/vision/values with diversity and inclusion. Develop sound operating systems, stay up‑to‑date with legal requirements. Define goals, design strategy, execute with precision.",
  ...
  {
    title: "Strategic Execution & Performance",
    icon: <HiOutlineTrendingUp />,
    desc: "Turn high‑level strategies into actionable roadmaps. Set KPIs, align teams, and drive measurable performance improvements across your organization.",
    img: "https://images.unsplash.com/photo-1554774853-602c57e6c5f6?q=80&w=800&auto=format&fit=crop",
    tags: ["KPIs", "Execution", "Performance"],
  },
  {
    title: "Compliance & Risk Advisory",
    icon: <HiOutlineShieldCheck />,
    desc: "Stay ahead of regulations with proactive risk assessments and compliance frameworks. Protect your business while enabling growth.",
...
const stats = [
  ...
  { val: "200+", label: "Expert Consultants" },
  { val: "40%", label: "Average ROI Improvement" },
  { val: "24/7", label: "Strategic Support" },
];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <HiOutlineSparkles style={{ fontSize: 16 }} /> Strategic Consulting
          </motion.div>
          <motion.h1
          ...
          >
            Business <br />
            <em style={{ color: T.sage, fontStyle: "italic" }}>Consulting</em>
          </motion.h1>
          <motion.p
            style={{
              fontSize: 17,
          ...
          >
            Knock down roadblocks and pave the path forward with the help of our professional business
            consultants. Formulate strategies and techniques that will lead you to pure market domination.
          </motion.p>
          <motion.div
        ...
        {/* Right hero image – consulting/strategy */}
        <motion.div
          style={{ position: "relative", zIndex: 2 }}
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 6 }}>
              ...
              />
              <span style={{ fontSize: 12, color: T.muted }}>Market Share Growth</span>
            </div>
          </motion.div>
        </motion.div>
      </section>
          ...
          <div>
            ...
            <Reveal delay={0.16}>
              <p style={{ fontSize: 16, lineHeight: 1.85, color: T.muted, marginBottom: 32 }}>
                Improve the overall flow of business and address compliance with data regulations in your
                industry. We help firms address functional challenges and gain a competitive edge by
                analyzing existing issues in finance, people, sales, and operations – and develop plans
                for improvement.
              </p>
            </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", maxWidth: 700, margin: "0 auto 64px" }}>
              <span className="af-eyebrow">Our Consulting Services</span>
              <h2
                className="af-display"
                style={{
              ...
              >
                Strategy. Execution. <em style={{ color: T.sage }}>Domination.</em>
              </h2>
              <p style={{ fontSize: 15, lineHeight: 1.8, color: T.muted }}>
                Hover each card to flip – from business intelligence to leadership advisory, our experts
                knock down roadblocks and pave the path forward.
              </p>
            </div>
          </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 52 }}>
              ...
              >
                Measurable <em style={{ color: T.goldLight }}>Consulting Results</em>
              </h2>
            </div>
          </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", maxWidth: 600, margin: "0 auto 60px" }}>
              ...
              >
                From Roadblocks to <em style={{ color: T.sage }}>Market Domination</em>
              </h2>
            </div>
          </Reveal>
          <div
          ...
          >
            ...
            />
            {[
              { num: "01", title: "Discover", desc: "We analyse your business, markets, and challenges." },
              { num: "02", title: "Strategise", desc: "Data‑driven planning and goal alignment." },
              { num: "03", title: "Integrate", desc: "Deploy technology and process improvements." },
              { num: "04", title: "Accelerate", desc: "Monitor KPIs, iterate, and scale success." },
            ].map((step, i) => (
              <motion.div
                key={i}
      ...
      >
        <div
          style={{
            position: "absolute",
            inset: 0,
            backgroundImage: `url(https://images.unsplash.com/photo-1554774853-602c57e6c5f6?q=80&w=1600&auto=format&fit=crop)`,
        ...
        >
          ...
          >
            Ready to dominate your market? Let’s craft a strategy that accelerates growth, integrates
            technology, and delivers measurable results.
          </p>
