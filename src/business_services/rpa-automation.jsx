// RPAAndAutomation.jsx – Fixed images (all working URLs)
...
/* ── AUTO-SCROLL STRIP (RPA keywords) ── */
const scrollItems = [
  "RPA",
  "Virtual Robots",
  "Process Automation",
...
/* ── Services (6 cards – ALL IMAGES REPLACED with working URLs) ── */
const services = [
  {
    title: "Harness RPA & Automation",
    icon: <HiOutlineChip />,
    desc: "Automation takes planning, monitoring, understanding of the goal, and proper execution to provide optimal ROI. Harness fast, highly efficient and cost‑effective virtual robots to allow proper implementation of business processes with continuity and flexibility. These intelligent software programs work like humans, commit zero mistakes, and do not sleep.",
    img: "https://images.unsplash.com/photo-1581092335871-4b6b5c7c3b9a?q=80&w=800&auto=format&fit=crop",
    tags: ["Virtual Robots", "Zero Mistakes", "24/7"],
  },
  {
    title: "Why Automate Business Process?",
    icon: <HiOutlineChartBar />,
    desc: "Developing and maintaining a team can be costly. When resources are limited, properly maintained automation allows increased workflow without extra personnel. Increase productivity, better resource utilization, work stress‑free with zero errors, processes handled at one‑fourth the cost, improve employee morale, enhance customer experience, and create value for better brand recognition.",
    img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format&fit=crop",
    tags: ["Cost‑saving", "Productivity", "Zero Errors"],
  },
  {
    title: "What Can You Automate?",
    icon: <HiOutlineClipboardList />,
    desc: "The sky is the limit. Automate repetitive daily computer tasks, sales data to accounting systems, invoice management, forecasting, error management, data extraction & formatting, recruitment, customer service, sales orders, payroll, price comparison, HR processing, refund processing, and much more.",
    img: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=800&auto=format&fit=crop",
    tags: ["Repetitive tasks", "Data extraction", "HR/Payroll"],
  },
  {
    title: "How We Succeed",
    icon: <HiOutlineRefresh />,
    desc: "Identify processes with greatest benefits, select easily automatable processes, get management buy‑in, understand and improve the process, develop a solution, test, run a pilot, go live, and maintain the RPA installation.",
    img: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=800&auto=format&fit=crop",
    tags: ["Methodology", "Pilot", "Continuous"],
  },
  {
    title: "Benefits of RPA",
    icon: <HiOutlineEmojiHappy />,
    desc: "Managers gain complete insight into employee responsibilities in real time, increasing accountability. Confidence that actions were executed correctly the first time, every time. Improved customer experience: faster response, enhanced interaction, word‑of‑mouth referrals. Improved employee morale: work‑life balance, skill development, zero stress.",
    img: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=800&auto=format&fit=crop",
    tags: ["Accountability", "Customer Experience", "Employee Morale"],
  },
  {
    title: "Service & Support",
    icon: <HiOutlineLightBulb />,
    desc: "End‑to‑end RPA lifecycle support – from process assessment to bot development, deployment, and ongoing maintenance. We ensure your automation delivers consistent ROI and adapts to changing business needs.",
    img: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=800&auto=format&fit=crop",
    tags: ["Support", "Maintenance", "ROI"],
  },
];
...
const stats = [
  { val: "100%", label: "Error Reduction" },
  { val: "75%", label: "Cost Savings" },
  { val: "24/7", label: "Uninterrupted Operations" },
  { val: "300%", label: "Productivity Boost" },
];

/* ════════════════════════════════════════════════════════════ */
export default function RPAAndAutomation() {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <HiOutlineSparkles style={{ fontSize: 16 }} /> RPA & Automation
          </motion.div>
          <motion.h1
          ...
          >
            RPA & <br />
            <em style={{ color: T.sage, fontStyle: "italic" }}>Automation</em>
          </motion.h1>
          <motion.p
            style={{
              fontSize: 17,
          ...
          >
            Tired of mundane, repetitive, unfulfilling jobs and being tied to your desk all the time?
            No worries – automate business processes and untie yourself from your desk. Lotus Analytics
            brings you intelligent virtual robots that work like humans, commit zero mistakes, and never sleep.
          </motion.p>
          <motion.div
        ...
        {/* Right image – automation concept (working) */}
        <motion.div
          style={{ position: "relative", zIndex: 2 }}
        ...
        >
          ...
          />
          <motion.img
            src="https://images.unsplash.com/photo-1581092335871-4b6b5c7c3b9a?q=80&w=1400&auto=format&fit=crop"
            alt="RPA automation"
            style={{
              width: "100%",
              height: 580,
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 6 }}>
              ...
              />
              <span style={{ fontSize: 12, color: T.muted }}>Productivity Increase</span>
            </div>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section id="about" style={{ background: T.white, padding: "100px 6%" }}>
        ...
        >
          ...
          <div>
            <Reveal>
              <span className="af-eyebrow">Why RPA & Automation</span>
            </Reveal>
            <Reveal delay={0.08}>
              <h2
                className="af-display"
            ...
            <Reveal delay={0.16}>
              <p style={{ fontSize: 16, lineHeight: 1.85, color: T.muted, marginBottom: 32 }}>
                Lotus Analytics brings you an automation service harnessing fast and highly efficient
                virtual robots – intelligent software programs that perform crucial but mundane tasks
                just like humans, commit zero mistakes, and do not sleep. Whether you need help automating
                an existing business process or are looking for an automation solution to perform repetitive
                functions, you’re right where you should be.
              </p>
            </Reveal>
            ...
            <Reveal delay={0.4}>
              ...
              >
                Explore Automation <HiArrowRight />
              </motion.a>
            </Reveal>
          </div>
        </div>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", maxWidth: 700, margin: "0 auto 64px" }}>
              <span className="af-eyebrow">RPA Solutions</span>
              <h2
                className="af-display"
                style={{
              ...
              >
                Automate. Accelerate. <em style={{ color: T.sage }}>Excel.</em>
              </h2>
              <p style={{ fontSize: 15, lineHeight: 1.8, color: T.muted }}>
                Hover each card to flip – discover how RPA transforms repetitive tasks into automated,
                error‑free workflows that run 24/7.
              </p>
            </div>
          </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 52 }}>
              ...
              >
                The Power of <em style={{ color: T.goldLight }}>RPA</em>
              </h2>
            </div>
          </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", maxWidth: 600, margin: "0 auto 60px" }}>
              <span className="af-eyebrow">Our RPA Methodology</span>
              <h2
                className="af-display"
                style={{
              ...
              >
                From Process to <em style={{ color: T.sage }}>Autonomous Bot</em>
              </h2>
            </div>
          </Reveal>
          <div
          ...
          >
            ...
            />
            {[
              { num: "01", title: "Identify", desc: "Pinpoint processes with greatest ROI potential." },
              { num: "02", title: "Design", desc: "Map workflow, rules, and exception handling." },
              { num: "03", title: "Develop", desc: "Build and configure virtual robots." },
              { num: "04", title: "Deploy", desc: "Pilot, then scale across the organization." },
            ].map((step, i) => (
              <motion.div
                key={i}
      ...
      >
        <div
          style={{
            position: "absolute",
            inset: 0,
            backgroundImage: `url(https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1600&auto=format&fit=crop)`,
        ...
        >
          ...
          >
            ...
            <br />
            <em style={{ color: T.gold }}>With Lotus RPA</em>
          </h2>
          <p
            style={{
              fontSize: 17,
          ...
          >
            Ready to automate repetitive tasks, reduce errors, and give your team back their time?
            Let’s discuss your automation journey today.
          </p>
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
            >
              Automate Your Workflow <HiArrowRight />
            </motion.a>
            <motion.a
              href="#services"
              className="af-btn-outline"
