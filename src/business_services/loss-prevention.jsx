// LossPrevention.jsx – Identity verification & fraud prevention landing page
...
/* ── AUTO-SCROLL STRIP (loss prevention keywords) ── */
const scrollItems = [
  "iVerify",
...
/* ── Services (6 cards covering identity verification & fraud prevention) ── */
const services = [
  {
    title: "Fraud And Loss Prevention – iVerify",
    icon: <HiOutlineShieldCheck />,
    desc: "Quickly and easily verify customers using a one-stop solution – iVerify. Built into our apps to provide end-to-end integration, so you get benefits using your existing applications. Add account security features like consumer identity verification and phone activation verification. Strengthen security by executing stringent identity verification policies across your business. Device risk assessment and user protection via client and customer verification technologies.",
    img: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?q=80&w=800&auto=format&fit=crop",
    tags: ["iVerify", "End-to-end", "Device risk"],
  },
  {
    title: "Identity Protection & Security",
    icon: <HiOutlineUserCircle />,
    desc: "Integrated consumer verification system to flag and prevent fraudulent sales. Identity Verification: Know who you are truly doing business with to prevent fraud and maintain compliance. Protect your brand and customers with multi‑layer identity proofing.",
    img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format&fit=crop",
    tags: ["Identity", "Compliance", "Fraud flag"],
  },
  {
    title: "Age Verification",
    icon: <HiOutlineCalendar />,
    desc: "Deploy reliable age verification that meets state and federal standards for age‑restricted products. Ensure compliance for alcohol, tobacco, cannabis, and other regulated goods with real‑time checks.",
    img: "https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?q=80&w=800&auto=format&fit=crop",
    tags: ["Age‑restricted", "Compliance", "Real‑time"],
  },
  {
    title: "Phone Verification",
    icon: <HiOutlinePhone />,
    desc: "Verify ownership of a phone number and authenticate via SMS or Programmatic voice. Add an extra layer of security for transactions, account creation, and high‑risk activities.",
    img: "https://images.unsplash.com/photo-1556742031-c6961e8560b0?q=80&w=800&auto=format&fit=crop",
    tags: ["SMS", "Voice", "2FA"],
  },
  {
    title: "Watch List Screening",
    icon: <HiOutlineClipboardList />,
    desc: "Comply with regulations by screening against multiple federal and international Watch Lists at once. Automate sanctions, PEP, and adverse media checks to mitigate risk.",
    img: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?q=80&w=800&auto=format&fit=crop",
    tags: ["Sanctions", "PEP", "Compliance"],
  },
  {
    title: "Device Risk Assessment",
    icon: <HiOutlineDesktopComputer />,
    desc: "Assess device fingerprints, location, and behavioral signals to detect fraudulent activity before it impacts your business. Protect users across web and mobile.",
    img: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=800&auto=format&fit=crop",
    tags: ["Fingerprinting", "Behavioral", "Detection"],
  },
];
...
const stats = [
  { val: "99.9%", label: "Verification Accuracy" },
  { val: "<2s", label: "Average Response Time" },
  { val: "45%", label: "Fraud Reduction" },
  { val: "500M+", label: "Annual Verifications" },
];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <HiOutlineSparkles style={{ fontSize: 16 }} /> iVerify™ Integration
          </motion.div>
          <motion.h1
          ...
          >
            Loss <br />
            <em style={{ color: T.sage, fontStyle: "italic" }}>Prevention</em>
          </motion.h1>
          <motion.p
            style={{
              fontSize: 17,
          ...
          >
            Know your customers and protect your business with an effective and end‑to‑end integrated
            solution. Drive business results while preventing fraud and conducting client identity
            verification, remotely and digitally.
          </motion.p>
          <motion.div
        ...
        {/* Right image – identity verification / security */}
        <motion.div
          style={{ position: "relative", zIndex: 2 }}
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 6 }}>
              ...
              />
              <span style={{ fontSize: 12, color: T.muted }}>Suspicious Attempts Prevented</span>
            </div>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section id="about" style={{ background: T.white, padding: "100px 6%" }}>
        ...
        >
          ...
          <div>
            <Reveal>
              <span className="af-eyebrow">Why Loss Prevention Matters</span>
            </Reveal>
            <Reveal delay={0.08}>
              <h2
                className="af-display"
            ...
            <Reveal delay={0.16}>
              <p style={{ fontSize: 16, lineHeight: 1.85, color: T.muted, marginBottom: 32 }}>
                iVerify is an effective tool that can be integrated end‑to‑end to perform customer identity
                verification, phone activation verification and more. Quickly and easily verify customers
                using a one‑stop solution. Built into our apps, iVerify provides end‑to‑end integration,
                so you can get the benefits using your existing applications. Add account security features,
                strengthen security by executing stringent identity verification policies across your business.
              </p>
            </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", maxWidth: 700, margin: "0 auto 64px" }}>
              <span className="af-eyebrow">Our Verification Solutions</span>
              <h2
                className="af-display"
                style={{
              ...
              >
                End‑to‑End <em style={{ color: T.sage }}>Identity & Fraud Prevention</em>
              </h2>
              <p style={{ fontSize: 15, lineHeight: 1.8, color: T.muted }}>
                Hover each card to flip – discover how iVerify and our suite of tools protect your business
                from fraud while ensuring seamless customer verification.
              </p>
            </div>
          </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 52 }}>
              ...
              >
                Real Impact of <em style={{ color: T.goldLight }}>iVerify</em>
              </h2>
            </div>
          </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", maxWidth: 600, margin: "0 auto 60px" }}>
              ...
              >
                Seamless Verification <em style={{ color: T.sage }}>In Seconds</em>
              </h2>
            </div>
          </Reveal>
          <div
          ...
          >
            ...
            />
            {[
              { num: "01", title: "Collect", desc: "Customer provides ID document and/or phone number via web or mobile." },
              { num: "02", title: "Verify", desc: "iVerify cross‑references against watch lists, databases, and biometrics." },
              { num: "03", title: "Assess", desc: "Real‑time risk assessment and device fingerprinting." },
              { num: "04", title: "Pass/Fail", desc: "Instant pass/fail decision with detailed audit trail for compliance." },
            ].map((step, i) => (
              <motion.div
                key={i}
      ...
      >
        <div
          style={{
            position: "absolute",
            inset: 0,
            backgroundImage: `url(https://images.unsplash.com/photo-1563013544-824ae1b704d3?q=80&w=1600&auto=format&fit=crop)`,
        ...
        >
          ...
          >
            ...
            <br />
            <em style={{ color: T.gold }}>With Lotus iVerify</em>
          </h2>
          <p
            style={{
              fontSize: 17,
          ...
          >
            Integrate iVerify into your existing apps today. Protect your revenue, your brand, and your
            customers with real‑time identity verification and fraud prevention.
          </p>
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
            >
              Request iVerify Demo <HiArrowRight />
            </motion.a>
            <motion.a
              href="#services"
              className="af-btn-outline"
