// Payroll.jsx – Fresh images, all unique, no repeats
...
/* ── Services – ALL NEW IMAGES (unique, never used before) ── */
const services = [
  {
    title: "Payroll Management",
    icon: <HiOutlineCash />,
    desc: "Review timesheets seamlessly, enter payroll information accurately, calculate and process payroll with payonline services. Generate paychecks, wire transfers, autopay, and print. Focus on your business – we handle the payroll hassle.",
    img: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=800&auto=format&fit=crop",
    tags: ["Timesheets", "Direct Deposit", "Real-time"],
  },
  {
    title: "Time & Attendance",
    icon: <HiOutlineClock />,
    desc: "Save time and improve payroll accuracy with state-of-the-art time clock, multiple location clock options, employee self-enrollment, payroll integration, and optional facial image capture. Gain back your sanity while increasing accuracy.",
    img: "https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?q=80&w=800&auto=format&fit=crop",
    tags: ["Biometric", "Accuracy", "Integration"],
  },
  {
    title: "Online Time Keeping",
    icon: <HiOutlineClock />,
    desc: "Full employee dashboard, time off and leave approval, shift swap management, customizable roles, employee self-enrollment, paperless, direct deposit, and online paystubs. Access the system 24/7 from anywhere.",
    img: "https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?q=80&w=800&auto=format&fit=crop",
    tags: ["24/7 access", "Self‑service", "Paperless"],
  },
  {
    title: "Android & iOS Ready",
    icon: <HiOutlineDeviceMobile />,
    desc: "Web and mobile device-friendly. Android and iOS ready, cloud hosted, mobile responsive, full employee management, modular design. Manage payroll on the go from any device.",
    img: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=80&w=800&auto=format&fit=crop",
    tags: ["Mobile", "Cloud", "Responsive"],
  },
  {
    title: "People Management",
    icon: <HiOutlineUserGroup />,
    desc: "Give employees and managers easy access to HR and payroll information from any device. Reduce support requests, simplify manager approvals, keep employee data safe. Empower your team with self‑service.",
    img: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=800&auto=format&fit=crop",
    tags: ["Self‑service", "Data security", "Approvals"],
  },
  {
    title: "Empower Employees & Increase Productivity",
    icon: <HiOutlineChartBar />,
    desc: "Simplify payroll and people management, reduce paperwork, have happier employees. Fast, efficient, secure, decreased compliance risk, customized user experience, reduced labor costs, flexible time tracking. Work smarter, free from manual processing.",
    img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format&fit=crop",
    tags: ["Productivity", "Compliance", "Efficiency"],
  },
];
...
const stats = [
  { val: "70%", label: "Faster Payroll Processing" },
  { val: "99.9%", label: "Accuracy Rate" },
  { val: "24/7", label: "Employee Access" },
  { val: "50%", label: "Reduced Admin Time" },
];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <HiOutlineSparkles style={{ fontSize: 16 }} /> Cloud Payroll
          </motion.div>
          <motion.h1
          ...
          >
            Payroll <br />
            <em style={{ color: T.sage, fontStyle: "italic" }}>Made Quick & Easy</em>
          </motion.h1>
          <motion.p
            style={{
              fontSize: 17,
          ...
          >
            Simplify, integrate and automate your payroll process so you can focus on things that matter
            most. Manage employee financial records – salaries, incentives, bonuses, deductions – effortlessly.
            Cloud‑based, 24/7 support, and ready for any business size.
          </motion.p>
          <motion.div
        ...
        {/* Right hero image – NEW (modern payroll/ accounting desk) */}
        <motion.div
          style={{ position: "relative", zIndex: 2 }}
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 6 }}>
              ...
              />
              <span style={{ fontSize: 12, color: T.muted }}>Time Saved</span>
            </div>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section id="about" style={{ background: T.white, padding: "100px 6%" }}>
        ...
        >
          ...
          <div>
            <Reveal>
              <span className="af-eyebrow">Overview</span>
            </Reveal>
            <Reveal delay={0.08}>
              <h2
                className="af-display"
            ...
            <Reveal delay={0.16}>
              <p style={{ fontSize: 16, lineHeight: 1.85, color: T.muted, marginBottom: 32 }}>
                It is imperative that your business maintain a steady and regular financial process by which
                you can pay your employees on time. Manage your company’s employee financial records through
                our efficient Payroll Management system. From salaries to incentives, bonuses and deductions,
                manage your payroll effortlessly. Lotus is a powerful, cloud‑based solution serving as a
                platform to manage employee records, streamline talent management, and access data for
                important decisions. Backed by 24/7 dedicated support.
              </p>
            </Reveal>
            ...
            <Reveal delay={0.4}>
              ...
              >
                See Payroll Features <HiArrowRight />
              </motion.button>
            </Reveal>
          </div>
        </div>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", maxWidth: 700, margin: "0 auto 64px" }}>
              <span className="af-eyebrow">Key Features</span>
              <h2
                className="af-display"
                style={{
              ...
              >
                Everything You Need <em style={{ color: T.sage }}>To Pay & Manage</em>
              </h2>
              <p style={{ fontSize: 15, lineHeight: 1.8, color: T.muted }}>
                Hover each card to flip – from time tracking to people management, we simplify payroll
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 52 }}>
              ...
              >
                Payroll <em style={{ color: T.goldLight }}>Excellence</em>
              </h2>
            </div>
          </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", maxWidth: 600, margin: "0 auto 60px" }}>
              ...
              >
                Simplify → Integrate → <em style={{ color: T.sage }}>Automate → Grow</em>
              </h2>
            </div>
          </Reveal>
          <div
          ...
          >
            ...
            />
            {[
              { num: "01", title: "Set Up", desc: "Add employees, define pay rates, and configure tax settings." },
              { num: "02", title: "Track", desc: "Employees clock in/out via web, mobile, or time clock." },
              { num: "03", title: "Approve", desc: "Managers review timesheets and approve payroll online." },
              { num: "04", title: "Pay", desc: "One‑click payroll runs with direct deposit or checks." },
            ].map((step, i) => (
              <motion.div
                key={i}
      ...
      >
        ...
        >
          ...
          >
            ...
            <br />
            <em style={{ color: T.gold }}>With Lotus Payroll</em>
          </h2>
          <p
            style={{
              fontSize: 17,
          ...
          >
            Stop spending hours on manual payroll. Join thousands of businesses that trust Lotus for fast,
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
            >
              Start Free Payroll Trial <HiArrowRight />
            </motion.a>
            <motion.button
              className="af-btn-outline"
              onClick={() => scrollTo("services")}
