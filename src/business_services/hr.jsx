// HRManagement.jsx – Human Resource tools & workforce management
...
/* ── Services (6 cards – HR Management, Scheduling, Reporting, plus extras) ── */
const services = [
  {
    title: "Human Resource Management",
    icon: <HiOutlineUsers />,
    desc: "Reduce administrative burden on managers with a modern self‑service experience for employees. Cloud‑based system, Android & iOS apps, Geo‑Location Check, IP Monitoring, employee self‑service, 24/7 access from any device. Integrate HR tools with your system to manage time and attendance, payroll, company policies and more with ease.",
    img: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=800&auto=format&fit=crop",
    tags: ["Self‑service", "Cloud", "Mobile"],
  },
  {
    title: "Scheduling & Accountability",
    icon: <HiOutlineCalendar />,
    desc: "Drive accountability and assure clear communications with our intuitive system. Combine employee scheduling and time punching to access demographic details of each employee. Features: schedule notifications, time off requests, copy schedule option, scheduled wage‑hour overview, cloud‑based, mobile responsive, dynamic store level flexibility, flexible time tracking options. Get greater visibility into employee time and labor costs.",
    img: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=800&auto=format&fit=crop",
    tags: ["Scheduling", "Time punching", "Labor costs"],
  },
  {
    title: "Customized & Automated Reporting",
    icon: <HiOutlineDocumentReport />,
    desc: "Get an overview of the overall status of different tasks, functions and verticals in the organization. Daily snapshots of a dashboard report showing attendance overview, manager ability to modify or correct timesheets. Reports include: Timecard discrepancy, Schedule vs. actual hours, Manager adjusted timecard, Employee roster, Timesheet, Overview report graph. Simplify complex paperwork and improve data accuracy.",
    img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=800&auto=format&fit=crop",
    tags: ["Dashboards", "Discrepancy", "Accuracy"],
  },
  {
    title: "Employee Self‑Service Portal",
    icon: <HiOutlineDeviceMobile />,
    desc: "Empower employees to manage their own information – view schedules, request time off, update personal details, and access pay stubs from any device. Reduces HR tickets and increases satisfaction.",
    img: "https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?q=80&w=800&auto=format&fit=crop",
    tags: ["24/7 access", "Mobile", "Empowerment"],
  },
  {
    title: "Time & Attendance Tracking",
    icon: <HiOutlineClock />,
    desc: "Real‑time tracking with geo‑fencing, IP monitoring, and biometric options. Automated overtime calculation, compliance with labor laws, and integration with payroll.",
    img: "https://images.unsplash.com/photo-1556742031-c6961e8560b0?q=80&w=800&auto=format&fit=crop",
    tags: ["Geo‑fencing", "Compliance", "Payroll ready"],
  },
  {
    title: "Payroll Integration",
    icon: <HiOutlineCreditCard />,
    desc: "Seamless integration with major payroll providers. Automate wage calculations, tax withholdings, and direct deposits. Eliminate manual data entry errors.",
    img: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=800&auto=format&fit=crop",
    tags: ["Automated", "Error‑free", "Direct deposit"],
  },
];
...
const stats = [
  { val: "40%", label: "Reduced Admin Time" },
  { val: "24/7", label: "Employee Access" },
  { val: "99%", label: "Schedule Accuracy" },
  { val: "50%", label: "Faster Payroll Processing" },
];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <HiOutlineSparkles style={{ fontSize: 16 }} /> Smart HR Solutions
          </motion.div>
          <motion.h1
          ...
          >
            Human <br />
            <em style={{ color: T.sage, fontStyle: "italic" }}>Resource</em>
          </motion.h1>
          <motion.p
            style={{
              fontSize: 17,
          ...
          >
            Make life easy for your employees by integrating robust and scalable HR tools to reduce costs
            and limit liability. From managing attendance and scheduling tasks to reporting and accountability,
            we’ve got it all covered. Focus on growing your business without the hassle of managing critical
            HR process complexities.
          </motion.p>
          <motion.div
        ...
        {/* Right image – HR / team collaboration */}
        <motion.div
          style={{ position: "relative", zIndex: 2 }}
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 6 }}>
              ...
              />
              <span style={{ fontSize: 12, color: T.muted }}>Faster Payroll</span>
            </div>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section id="about" style={{ background: T.white, padding: "100px 6%" }}>
        ...
        >
          ...
          <div>
            <Reveal>
              <span className="af-eyebrow">Why Integrated HR</span>
            </Reveal>
            <Reveal delay={0.08}>
              <h2
                className="af-display"
            ...
            <Reveal delay={0.16}>
              <p style={{ fontSize: 16, lineHeight: 1.85, color: T.muted, marginBottom: 32 }}>
                Human Resource is an integral function that can underpin business survival.
                Integrate robust and scalable HR tools to reduce costs, limit liability and make
                life easy for your employees. From managing attendance and scheduling tasks to
                reporting and accountability, we cover everything. Focus on growing your business
                without the hassle of managing critical HR process complexities.
              </p>
            </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", maxWidth: 700, margin: "0 auto 64px" }}>
              <span className="af-eyebrow">Our HR Solutions</span>
              <h2
                className="af-display"
                style={{
              ...
              >
                Empower Employees. <em style={{ color: T.sage }}>Streamline Operations.</em>
              </h2>
              <p style={{ fontSize: 15, lineHeight: 1.8, color: T.muted }}>
                Hover each card to flip – discover how our HR tools reduce administrative burden,
                improve accountability, and give you real‑time insights.
              </p>
            </div>
          </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 52 }}>
              ...
              >
                Measurable <em style={{ color: T.goldLight }}>HR Impact</em>
              </h2>
            </div>
          </Reveal>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", maxWidth: 600, margin: "0 auto 60px" }}>
              ...
              >
                From Setup to <em style={{ color: T.sage }}>Self‑Service</em>
              </h2>
            </div>
          </Reveal>
          <div
          ...
          >
            ...
            />
            {[
              { num: "01", title: "Assess", desc: "We analyse your current HR processes and pain points." },
              { num: "02", title: "Configure", desc: "Tailor the HR tools to your policies, roles, and workflows." },
              { num: "03", title: "Integrate", desc: "Connect with your existing payroll, ERP, and communication systems." },
              { num: "04", title: "Empower", desc: "Launch employee self‑service and train managers on real‑time reporting." },
            ].map((step, i) => (
              <motion.div
                key={i}
      ...
      >
        ...
        >
          ...
          >
            ...
            <br />
            <em style={{ color: T.gold }}>With Lotus HR</em>
          </h2>
          <p
            style={{
              fontSize: 17,
          ...
          >
            Reduce costs, limit liability, and empower your workforce. Let’s discuss how our HR tools
            can transform your people operations.
          </p>
